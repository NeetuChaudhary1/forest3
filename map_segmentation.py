...
for x in range(cols):
    for y in range(rows):
        ...
        urlparams = urllib.parse.urlencode({'center': position,
                                            ...
                                            'sensor': 'false',
                                            'scale': scale,
                                            'key': 'AIzaSyBaAt4Omrxfk8lDdeCb6tIK2F1Ae0VkC7Q'})
        urlparamsmaps = urllib.parse.urlencode({'center': position,
                                                ...
                                                'scale': scale,
                                                'key': 'AIzaSyBaAt4Omrxfk8lDdeCb6tIK2F1Ae0VkC7Q'})
        url = 'https://maps.googleapis.com/maps/api/place/textsearch/json' + urlparams
        url1 = 'https://maps.googleapis.com/maps/api/place/textsearch/json' + urlparamsmaps
